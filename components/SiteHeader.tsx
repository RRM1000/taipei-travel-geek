...
const megaMenuCards: Record<PrimaryKey, MegaCard[]> = {
  ...
  Drink: [
    ...
    { slug: "cheap-coffee", title: "The Best Places for a Cheap but Tasty Coffee", image: "/media/2019/07/Louisa-8-1024x768.jpg", excerpt: "Good coffee without the damage to your wallet." },
